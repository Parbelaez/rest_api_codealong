...
REST_AUTH_SERIALIZERS = {
    'USER_DETAILS_SERIALIZER': 'rest_api_codealong.serializers.CurrentUserSerializer'
}
...
ROOT_URLCONF = 'rest_api_codealong.urls'
...
WSGI_APPLICATION = 'rest_api_codealong.wsgi.application'
